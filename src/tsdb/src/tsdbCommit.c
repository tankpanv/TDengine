 ...
 * for TSDB_TIME_PRECISION_MILLI: 3600L
 *     TSDB_TIME_PRECISION_MICRO: 3600000L
 *     TSDB_TIME_PRECISION_NANO:  3600000000L
 */
static int64_t tsTickPerHour[] = {3600L, 3600000L, 3600000000L};
